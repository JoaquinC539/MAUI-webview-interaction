...
`;function a(){console.log("render main"),document.querySelector("#app").innerHTML=g;function c(){const t=()=>{console.log("navigate about"),history.pushState({},"","/about"),p()};document.querySelector("#aSpa").addEventListener("click",()=>{t()})}u(document.querySelector("#counter")),c()}a();
